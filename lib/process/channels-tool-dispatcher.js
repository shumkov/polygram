 ...
 * @param {Function} [deps.makeDeliverText]        — ({sessionKey, sessionCwd, chatId, threadId, interim, turnId}) → deliverText
 *   strategy for the reply pipeline (see process-agent-reply.js). Built per call because
 *   sessionCwd, the interim flag, and the turn id are only known here. Injected rather
