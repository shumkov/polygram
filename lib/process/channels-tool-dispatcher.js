 ...
 *   sessionCwd is only known here. Injected rather than required: rich-media.js requires
 *   THIS module, so importing the rich modules from here would close a require cycle.
