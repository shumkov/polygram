...
const MODEL_COSTS = {
  ...
  // Claude Opus 4.8 — kept for turns recorded before the CLI pin moved to
  // 2.1.220; without an entry those fall back to the Sonnet `default`.
  'claude-opus-4-8': { input: 15, output: 75, cacheRead: 1.50, cacheCreation: 18.75 },
  // Claude Opus 5 — what `--model opus` resolves to on the pinned CLI.
  'claude-opus-5': { input: 5, output: 25, cacheRead: 0.50, cacheCreation: 6.25 },
