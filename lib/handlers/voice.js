...
function createTranscribeVoiceAttachments({
  ...
  if (typeof transcribeVoice !== 'function') throw new TypeError('transcribeVoice required');
  if (typeof isVoiceAttachment !== 'function') throw new TypeError('isVoiceAttachment required');
