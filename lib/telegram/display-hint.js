...
const INLINE_MEDIA_PARAGRAPHS = [
  ...
  '',
  '**Media and live streaming do not mix.** A message that streams grows by editing, and an edited bubble can never gain media — images degrade to their caption text. When your answer includes media, keep the media OUT of the streamed report: stream the prose, and deliver the media in its own separate reply (with at least a sentence of text). Do not put media in a message you are streaming.',
  '',
];
