...
const EXTENSION_ALLOW = new Set([
  // archives — extensionOf() only sees the last dot segment, so
  // "foo.tar.gz" resolves to 'gz' (not 'tar.gz'); listing 'gz'/'tgz'/'tar'
  // separately covers the common compound and short forms.
  'zip', 'gz', 'tgz', 'tar',
