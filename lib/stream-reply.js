...
function createStreamer({
  ...
  // each. Pre-0.7.2 (since 0.7.0 multi-bubble support landed) ALL
  // bubbles were kept; 0.7.2 added the archive-and-delete-at-turn
  // for OpenClaw-parity. rc.44 reverted the default to preserve
  // (matches 0.7.0). archived[] only fills when
